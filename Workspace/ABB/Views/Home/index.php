		...
		<section id="plot3d">
			<div class="page-header">
				...
				<div id="surfacePlotDiv"
					style="float: left; width: 950px; height: 700px;" oncontextmenu="return false" onmouseover="document.body.style.overflow='hidden';" onmouseout="document.body.style.overflow='auto';">
